<div>
    ...
    "
                            ...
                            <x-label>
                                Calle
                                <input wire:model="ubicaciones.solicitante.calle" class="block rounded-lg mt-2 w-full" type="text">
                            ...
                            <x-label>
                                Casa / Edificio
                                <input wire:model="ubicaciones.solicitante.casa_edificio" class="block rounded-lg mt-2 w-full" type="text">
                            ...
                            <x-label>
                                Piso
                                <input wire:model="ubicaciones.solicitante.piso" class="block rounded-lg mt-2 w-full" type="text">
                            ...
                            <x-label>
                                Apartamento
                                <input wire:model="ubicaciones.solicitante.apartamento" class="block rounded-lg mt-2 w-full" type="text">
                            ...
                            <x-label>
                                ...
                                <div x-data="{
                                    ...
                                    <input x-model="search" @focus="open = true" @input="open = true" type="text"
                                        placeholder="Buscar dependencia..."
                                        class="block rounded-lg mt-2 w-full border border-gray-300" autocomplete="off">
                            ...
                            @if ($showAssigned)
                                ...
                                <x-label>
                                    Calle
                                    <input wire:model="ubicaciones.apoderado.calle" class="block rounded-lg mt-2 w-full" type="text">
                                ...
                                <x-label>
                                    Casa / Edificio
                                    <input wire:model="ubicaciones.apoderado.casa_edificio" class="block rounded-lg mt-2 w-full" type="text">
                                ...
                                <x-label>
                                    Piso
                                    <input wire:model="ubicaciones.apoderado.piso" class="block rounded-lg mt-2 w-full" type="text">
                                ...
                                <x-label>
                                    Apartamento
                                    <input wire:model="ubicaciones.apoderado.apartamento" class="block rounded-lg mt-2 w-full" type="text">
                                ...
                                <x-label>
                                    Teléfono Local
                                    <input x-data x-model="telefonolocal_apoderado" x-ref="telefonolocal_apoderado"
                                        @input="
                            ...
                            <x-label>
                                Calle
                                <input wire:model="ubicaciones.abogado.calle" class="block rounded-lg mt-2 w-full" type="text">
                                @error('calle_abogado')
                                <span class="text-red-500 text-xs mt-3 block ">{{ $message }}</span>
                                @enderror
                            ...
                            <x-label>
                                Casa / Edificio
                                <input wire:model="ubicaciones.abogado.casa_edificio" class="block rounded-lg mt-2 w-full" type="text">
                            ...
                            <x-label>
                                Piso
                                <input wire:model="ubicaciones.abogado.piso" class="block rounded-lg mt-2 w-full" type="text">
                                @error('piso_abogado')
                                <span class="text-red-500 text-xs mt-3 block ">{{ $message }}</span>
                                @enderror
                            </x-label>
                            <x-label>
                                Apartamento
                                <input wire:model="ubicaciones.abogado.apartamento" class="block rounded-lg mt-2 w-full" type="text">
                        ...
                        <div class="grid grid-cols-9 mt-3">
                            <button type="submit"
                                class="col-start-9 col-span-1 py-3 px-6 bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-base font-medium text-white rounded-md shadow-md transition duration-300 ease-in-out text-center justify-center">Enviar</button>
                        </div>
                    </form>
                </div>
            </div>
